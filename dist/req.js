...
(function (global, factory) {
  ...
  utils.forEach(['post', 'put', 'patch'], function (method) {
    return defaults.headers[method] = utils.merge(DEFAULT_CONTENT_TYPE);
  });
  ...
  function dispatchRequest(config) {
    ...
    return adapter.call(this, config).then(function (response) {
      throwIfCancellationRequested(config);
  ...
  var req = createInstance(defaults);
